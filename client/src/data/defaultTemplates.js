export const defaultTemplates = [
  {
    ...
    description: 'First email parties receive once a mediation is booked.',
...
{{mediatorName}}</p>`,
  },
  {
    ...
    description: 'Sent to remind users if they have not completed the onboarding form.',
...
{{mediatorName}}</p>`,
  },
  {
    id: 'default-3',
    name: 'New Invoice',
    description: 'Sent once the onboarding form is completed and the invoice is created.',
...
{{mediatorName}}</p>`,
  },
  {
    ...
    description: 'Sent if payment is not made. Cadence is controllable.',
...
{{mediatorName}}</p>`,
  },
  {
    id: 'default-5',
    name: 'Brief Reminder',
    description: 'Sent if the brief has not been uploaded. Cadence is controllable.',
...
{{mediatorName}}</p>`,
  },
  {
    ...
    description: 'Sent once both parties complete the onboarding form and the Zoom link is created.',
...
{{mediatorName}}</p>`,
  },
  {
    ...
    description: 'Sent to all parties if the mediation date is changed.',
